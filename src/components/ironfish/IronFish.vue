  ...
  >
    <template #product-info>
      ...
      <div class='three-section' v-if='sdk.appPowerRental.canBuy(target?.AppGoodID as string)'>
        ...
        <br>
        <span class='unit'>{{ sdk.appPowerRental.saleEndDate(target?.AppGoodID as string) }} {{ $t("MSG_JST") }}</span>
        <div class='tooltip'>
...
import { appcoin, appcoindescription, coincurrency, utils, constant, sdk } from 'src/npoolstore'
