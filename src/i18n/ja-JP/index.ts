...
export default {
  ...
  MSG_FAQ: 'FAQ & サポート',
  MSG_LEGAL: '規約',
  MSG_SUPPORT_CENTER: 'サポートセンター',
  MSG_PROCYON_PLATFORM: 'Procyon プラットフォーム',
  ...
  MSG_PAYMENTS_FAQ_MENU_SUBTITLE: 'Procyon.vipでの支払いに関する詳細を確認',
  MSG_KYC_FAQ_MENU_TITLE: 'KYC (本人確認)',
  MSG_KYC_FAQ_MENU_SUBTITLE: 'KYC (本人確認) の申請に関する詳細を確認',
  MSG_SECURITY_FAQ_MENU_TITLE: '情報セキュリティポリシー',
  MSG_SECURITY_FAQ_MENU_SUBTITLE: 'Procyon.vipのセキュリティポリシーに関する詳細を確認',
  MSG_GENERAL_FAQ_MENU_TITLE: '総合案内',
  MSG_GENERAL_FAQ_MENU_SUBTITLE: 'その他Procyon.vipに関する一般的な情報を確認',
